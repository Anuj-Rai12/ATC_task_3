...
fun getRandImage(): String {
    val images = listOf(
        "https://images.unsplash.com/photo-1533387520709-752d83de3630?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=334&q=80",
